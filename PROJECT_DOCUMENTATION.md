...
### [College Address, City, State – PIN Code]
...
This is to certify that the project work entitled **"AI FACE RECOGNITION AND MONITORING SYSTEM"** submitted by **Nkingsapbe Nring**, University Roll No. **22CS018**, is a bonafide work carried out by him/her in partial fulfillment of the requirements for the award of the degree of **Bachelor of Computer Applications (BCA)** from **Don Bosco Collge ()Autonomouse) Maram** during the academic year **2025–2026**.
...
I hereby declare that the project work entitled **"AI FACE RECOGNITION AND MONITORING SYSTEM"** submitted to **Don Bosco College (Autonomouse) Maram** in partial fulfillment of the requirements for the award of the degree of **Bachelor of Computer Applications (BCA)** is a record of original work done by me under the supervision and guidance of **Samarendra**, **Professor** Department of Computer Applications, **DBC(A)M**

The matter presented in this report has not been submitted by me for the award of any other degree of this or any other university or institution.

I also declare that all information, material, and data contained in this project report are authentic to the best of my knowledge.
...
First and foremost, I would like to thank the **Almighty God** for giving me the strength, knowledge, ability, and opportunity to undertake this project and to persevere through it. Without His blessings, this achievement would not have been possible.

I express my heartfelt thanks to our esteemed **Principal, [Principal Name]**, for providing all the necessary facilities, infrastructure, and a conducive learning environment that made this project possible.

I am deeply indebted to my project guide, **[Guide Name]**, **[Designation]**, Department of Computer Applications, for the invaluable guidance, constant supervision, constructive criticism, and encouragement provided throughout the course of this project. His/Her timely suggestions and scholarly advice helped me in shaping this project into its present form.

I extend my sincere gratitude to **Prof. [HOD Name]**, Head of the Department of Computer Applications, for his/her constant support, motivation, and the academic environment fostered in the department that enabled me to focus on my research and development.

I also take this opportunity to express my heartfelt thanks to all the **faculty members** of the Department of Computer Applications who, directly or indirectly, contributed to the successful completion of this project through their generous help, cooperation, and academic insights.

A special thanks goes to the **laboratory staff** for their technical support and for ensuring the smooth functioning of the computer laboratory during the development phase of this project.

Last but not least, I am extremely grateful to my **parents, family members, and friends** who have been a constant source of emotional and moral support throughout this project. Their patience, understanding, and encouragement played a vital role in the successful completion of this work.
